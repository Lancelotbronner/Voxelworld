...
legacy_geometry_t geometry_legacy_init(GLsizei capacity) {
	legacy_geometry_t geometry = malloc(sizeof(struct legacy_geometry_s));
...
void geometry_upload_to(legacy_geometry_t geometry, legacy_mesh_t *mesh) {
	...
	// reset the geometry
	struct legacy_geometry_s tmp = *geometry;
	*geometry = (struct legacy_geometry_s){ };
