...
Minecraft clone, currently macOS only. Forked from Michael Fogleman's old repository [website](https://www.michaelfogleman.com/projects/craft) [github](https://github.com/fogleman/Craft).

![Screenshot](https://i.imgur.com/SH7wcas.png)

## Features

* Simple dependency management using Swift Package Manager
* Modern C23 codebase with most warnings enabled
* Simple but nice looking terrain generation using perlin / simplex noise.
* More than 10 types of blocks and more can be added easily.
* Supports plants (grass, flowers, trees, etc.) and transparency (glass).
* Simple clouds in the sky (they don't move).
* Day / night cycles and a textured sky dome.
* World changes persisted in an sqlite3 database.

## Installation

Everything should be included and configured with SwiftPM so you should only need to `swift build`!
